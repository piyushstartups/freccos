...
export default function AddBucketListSheet({ open, onClose, onAdded }) {
  ...
  const submit = async () => {
    ...
    setSubmitting(true);
    try {
      const { data } = await api.post("/trip-plans/bucket-list", {
        city_name: cityName,
